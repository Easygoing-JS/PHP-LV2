<?php
    ...
    {
        public function foo()
        {                  // есть у всех объектов, в том числе производных классов
            static $x = 0; // статическая переменная.
            // Теперь принадлежит классам А и B
            // ( т.к. функция имеет модификатор public)
    ...
    // ########## задание №6* ##########
    // небольшие измененния — увидим от какого класса пришла переменная
    class A
    {
        public function foo()
        {                  // есть у всех объектов, в том числе прозводных классов
            static $x = 0; // статическая переменная.
    ...
    // ########## задание №6 ##########
    // переопределен метод в производном классе
    class A
    {
        public function foo()
        {                  // есть у всех объектов, в том числе прозводных классов
    ...
    // ########## задание №6 ##########
    // замена get_class($this) на __CLASS__ : значение переменной не изменилось
