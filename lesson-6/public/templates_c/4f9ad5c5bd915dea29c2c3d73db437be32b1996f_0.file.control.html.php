                            ...
                            <tr>
                                <?php
                                    ...
                                    foreach ($_from as $_smarty_tpl->tpl_vars['k']->value => $_smarty_tpl->tpl_vars['value']->value) {
                                        ...
                                        <td>
                                            <input type="text"
                                                   name="<?php echo $_smarty_tpl->tpl_vars['item']->value->id; ?>
...
" <?php if ($_smarty_tpl->tpl_vars['k']->value == 'id') { ?>DISABLED<?php } ?>>
                                ...
                                <td>
                                    <input type="submit"
                                           name="__save_<?php echo $_smarty_tpl->tpl_vars['item']->value->id; ?>
" value="Сохранить">
                                    <input type="submit"
                                           name="__delete_<?php echo $_smarty_tpl->tpl_vars['item']->value->id; ?>
" value="Удалить">
                                </td>
                            </tr>
                            <?php
                    ...
                    <tr>
                        <?php
                            ...
                            foreach ($_from as $_smarty_tpl->tpl_vars['k']->value => $_smarty_tpl->tpl_vars['field']->value) {
                                ...
                                <td>
                                    <input type="text"
                                           name="new_<?php echo $_smarty_tpl->tpl_vars['field']->value['Field']; ?>
" <?php if ($_smarty_tpl->tpl_vars['k']->value == 'id') { ?>DISABLED<?php } ?>>
                                </td>
                                <?php
